package com.victorescalante.rickyandmorty_mvvm_cleanarquitecture_sample.domain.usecase

import com.victorescalante.rickyandmorty_mvvm_cleanarquitecture_sample.data.source.local.entity.toRoom
import com.victorescalante.rickyandmorty_mvvm_cleanarquitecture_sample.domain.model.CharacterModel
import com.victorescalante.rickyandmorty_mvvm_cleanarquitecture_sample.domain.model.toDomain
import com.victorescalante.rickyandmorty_mvvm_cleanarquitecture_sample.domain.repository.CharacterRepository
import com.victorescalante.rickyandmorty_mvvm_cleanarquitecture_sample.util.Resource
